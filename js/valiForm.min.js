    ...
    var t, e = !1,
        ...
        a = function(n, a) {
            var o = document.getElementById("snackbar"),
                i = r(n);
            o.style.position = "absolute", o.style.left = i.x + "px", o.style.top = i.y + "px",o.style.zindex = '9999', e && (o.className = "snack_hidden", clearTimeout(t)), e = !0, o.getElementsByTagName("p")[0].innerHTML = a, o.className = "snack_visible", t = setTimeout(function() {
